...
def loss(params, cstate, cconditionals, ctarget):
    runner = jax.vmap(
        partial(hamiltonian_eom, learned_dynamics(params, nn_forward_fn)), (0, 0), 0
    )
...
# %%
best_params = pkl.load(open("best_sr_params_hamiltonian_true_canonical.pkl", "rb"))[
    "params"
]
